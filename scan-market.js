...
var poly_sdk_1 = require("@catalyst-team/poly-sdk");
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    sdk = new poly_sdk_1.PolymarketSDK();
                    return [4 /*yield*/, sdk.dipArb.scanUpcomingMarkets({
                            coin: 'BTC',
                            duration: '5m',
                ...
                case 1:
                    ...
                    if (btcMarkets.length === 0) {
                        //console.log('No btc 5m markets found. This could be normal if no markets are active.\n');
                    }
                    else {
                        btcMarkets.forEach(function (m, i) {
                            var minutesLeft = Math.round((m.endTime.getTime() - Date.now()) / 60000);
                            //console.log(`${i + 1}. ${m.name}`);
                            //console.log(`   Slug: ${m.slug}`);
                            console.log("   Condition ID: ".concat(m.conditionId));
