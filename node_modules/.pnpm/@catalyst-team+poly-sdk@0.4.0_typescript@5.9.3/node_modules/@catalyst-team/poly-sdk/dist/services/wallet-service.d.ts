...
export declare class WalletService {
     ...
     * ```
     */
    getWalletActivity(address: string, options?: WalletActivityOptions | number): Promise<WalletActivitySummary>;
    /**
     * Get leaderboard
     */
     ...
     * ```
     */
    getLeaderboardByPeriod(period: TimePeriod, limit?: number, sortBy?: LeaderboardSortBy, category?: LeaderboardCategory, offset?: number): Promise<PeriodLeaderboardEntry[]>;
    /**
