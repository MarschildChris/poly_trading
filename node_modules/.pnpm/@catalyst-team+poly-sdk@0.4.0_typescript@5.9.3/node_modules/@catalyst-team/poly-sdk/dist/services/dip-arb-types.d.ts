 ...
 * 默认配置
 */
export declare const DEFAULT_DIP_ARB_CONFIG: DipArbConfigInternal;
/** 支持的底层资产 */
 ...
 * 默认自动轮换配置
 */
export declare const DEFAULT_AUTO_ROTATE_CONFIG: Required<DipArbAutoRotateConfig>;
/**
 * 结算结果
 */
 ...
 * 创建初始统计
 */
export declare function createDipArbInitialStats(): DipArbStats;
/**
 * 创建新轮次状态
 */
export declare function createDipArbRoundState(roundId: string, priceToBeat: number, upPrice: number, downPrice: number, durationMinutes?: number): DipArbRoundState;
/**
 * 计算利润率
 */
export declare function calculateDipArbProfitRate(totalCost: number): number;
/**
 * 计算基于底层资产价格变化的"真实"胜率
 *
 ...
 */
export declare function estimateUpWinRate(currentPrice: number, priceToBeat: number): number;
/**
 * 检测定价偏差
 *
 ...
 */
export declare function detectMispricing(tokenPrice: number, estimatedWinRate: number): number;
/**
 * 从 slug 解析底层资产
 * e.g., 'btc-updown-15m-1767165300' → 'BTC'
 */
export declare function parseUnderlyingFromSlug(slug: string): DipArbUnderlying;
/**
 * 从 slug 解析时长
 * e.g., 'btc-updown-15m-1767165300' → 15
 */
export declare function parseDurationFromSlug(slug: string): DipArbDuration;
/**
 * 类型守卫：检查是否为 Leg1 信号
 */
export declare function isDipArbLeg1Signal(signal: DipArbSignal): signal is DipArbLeg1Signal;
/**
 * 类型守卫：检查是否为 Leg2 信号
 */
export declare function isDipArbLeg2Signal(signal: DipArbSignal): signal is DipArbLeg2Signal;
//# sourceMappingURL=dip-arb-types.d.ts.map