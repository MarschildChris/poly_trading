...
import { BridgeClient, SUPPORTED_CHAINS, BRIDGE_TOKENS, estimateBridgeOutput, getExplorerUrl, } from '../../clients/bridge-client.js';
describe('BridgeClient Integration', () => {
    ...
    describe('Constants', () => {
        ...
        it('should have correct token addresses', () => {
            ...
            expect(BRIDGE_TOKENS.ETH_USDC.toLowerCase()).toBe('0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48');
            expect(BRIDGE_TOKENS.POLYGON_USDC_E.toLowerCase()).toBe('0x2791bca1f2de4661ed88a30c99a7a9449aa84174');
...
//# sourceMappingURL=bridge-client.integration.test.js.map